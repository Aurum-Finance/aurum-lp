...
export const HOW_IT_WORKS_DATA: StepCard[] = [
  {
    ...
    height: "269px",
    description:
      "Your journey begins with a SOL deposit. For every 100 SOL entrusted to our vaults, your entire balance starts generating yield immediately through our carefully selected strategies.",
  },
  {
    id: 2,
    ...
    height: "328px",
    description:
      "Access up to 50 aurSOL for every 100 SOL deposited. Use aurSOL across Solana's ecosystem while your original deposit continues its yield-generating journey.",
  },
  {
    id: 3,
    ...
    description: {
      ...
      points: [
        ...
        },
        {
          ...
          description:
            "Our proprietary yield optimization engine that navigates through multiple DeFi strategies for optimal returns",
        },
      ],
    },
  },
